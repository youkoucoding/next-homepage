...
const Banner = () => (
  <header className='bg-gradient-to-t from-secondary to-opacity'>
    ...
    <div className='min-h-full'>
      ...
      {/* buttons */}
      <div className='mt-5 flex justify-center items-center w-full mx-auto space-x-6'>
      ...
      <div className='flex justify-center w-full'>
        <div className='wu-full'>
          <div className='flex items-center justify-center mx-auto flex-wrap'>
            <img className='w-24 h-24 m-8' src='cpu.svg' alt='cpu' />
            <img className='w-24 h-24 m-8' src='innovation.svg' alt='cpu' />
            <img className='w-24 h-24 m-8' src='network.svg' alt='cpu' />
            <img className='w-24 h-24 m-8' src='project-management.svg' alt='cpu' />
          </div>
        </div>
      </div>
    </div>
